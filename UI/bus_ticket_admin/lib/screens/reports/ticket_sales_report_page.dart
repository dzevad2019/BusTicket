...
class TicketSalesReportPage extends StatefulWidget {
  const TicketSalesReportPage({Key? key}) : super(key: key);

  @override
  _TicketSalesReportPageState createState() => _TicketSalesReportPageState();
}
...
class _TicketSalesReportPageState extends State<TicketSalesReportPage> {
  ...
  Future<void> _downloadReport() async {
    ...
    try {
      final filePath = await _reportsProvider.ticketSales(selectedCompany?.id, fromDate!, toDate!);
