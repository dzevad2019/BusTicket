import 'package:bus_ticket_mobile/models/bus_line_segment.dart';
import 'package:bus_ticket_mobile/models/discount.dart';
...
class Ticket {
  ...
  factory Ticket.fromJson(Map<String, dynamic> json) {
    return Ticket(
      ...
      //payedBy: json['payedBy'] != null ? User.fromJson(json['payedBy']) : null,
